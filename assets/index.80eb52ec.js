import"./index.abafae97.js";function $(t){return Math.sqrt(1- --t*t)}function y(t){const o=t-1;return o*o*o+1}function d(t,{delay:o=0,duration:a=400,easing:e=y,x:f=0,y:i=0,opacity:s=0}={}){const n=getComputedStyle(t),r=+n.opacity,p=n.transform==="none"?"":n.transform,u=r*(1-s);return{delay:o,duration:a,easing:e,css:(m,c)=>`
